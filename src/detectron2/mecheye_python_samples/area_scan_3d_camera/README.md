...
* **advanced**
  ...
  * `advanced/point_cloud_from_2d_mask.py`
    From an external 2D mask (e.g. PointRend/Mask R-CNN) generate an untextured or textured point cloud via `get_point_cloud_after_mapping()`.
