...
if __name__ == '__main__':
    ...
    # 拔出位置
    # -0.7581543061002071, -0.14395913522860007, 0.2686252697122423, 3.1364096186503945, -0.01723700236756983, 0.009730743533185687
    # 安全位置
    # -0.7578968924400122, -0.14406518247257039, 0.2969422006223111, 3.1361170894647663, -0.01676073190553281, -0.0012481617511223622

    safeoutpos = [-0.7558968924400122, -0.14406518247257039, 0.2969422006223111, 3.1361170894647663, -0.01676073190553281, -0.0012481617511223622]
    rtde_c.moveL(safeoutpos)
    time.sleep(2)

    # outpos = [-0.7581543061002071, -0.14395913522860007, 0.2686252697122423, 3.1364096186503945, -0.01723700236756983, 0.009730743533185687]
    # servo_move_slow(outpos)
    # time.sleep(2)
    ...
    print(F_zero)
    setpoint1 = [F_zero[0], F_zero[1], F_zero[2] - 9, F_zero[3], F_zero[4], F_zero[5]]
