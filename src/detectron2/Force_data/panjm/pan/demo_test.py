...
class PID:
    ...
    def update(self, feedback_value):
        ...
        if (delta_time >= self.sample_time):
            ...
            self.ITerm += error * delta_time  #p_now = rtde_r.getActualTCPPose()
...
def force_control(setpoint, force_con, action,pid):
    ...
    # p_now1 = rtde_r.getActualTCPPose()
    # print("p_now",p_now1)
...
if __name__ == '__main__':
    ...
    startpos2 = [-0.5585785650682801, -0.15221369783661026, 0.48503041758609533, -3.1364176528033347, 0.0680219188372179, -0.024227414709890132]
    # startpos3 = [-0.5815805895001666, -0.2113980728671856, 0.4562633389803402, 0.0030592128382204947,
    #              -3.1224528633398774, 0.0009334453143928785]
