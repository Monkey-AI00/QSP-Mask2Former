...
if __name__ == '__main__':
    starttime = time.time()
    pid = []
    dt = 1.0 / 300#控制频率300HZ

    # P = [0, 0, m, 0, 0, 0]
    # I = [0, 0, o / 10, 0, 0, 0]
    m = 0.000008
    o = m / 100
    P = [m, m, 0.000008 * 5, m * 200, m * 200, m * 200]#PID比例系数
    ...
    startpos2 = [-0.6805216272138487, -0.021637449166239848, 0.24150758683615292, -0.2156378921472215, 2.6194784703794505, -0.018397260383279726]
    #移动到初始位置
    ...
    print('初始受力',F_zero)
    setpoint_insert = [F_zero[0], F_zero[1], F_zero[2]+10 , F_zero[3], F_zero[4], F_zero[5]]#目标：Z轴增加10N的力
    action_insert = [0, 0,-0.002,0, 0, 0]#Z轴持续下压微调，步长0.002m，注意单位是米

    setpoint_extract = [F_zero[0], F_zero[1], F_zero[2]-5, F_zero[3], F_zero[4], F_zero[5]]
    action_extract = [0, 0, 0.001, 0, 0, 0]
